...
其实这两道题目先做那一道都可以，但我先写的 42.接雨水的题解，所以如果没做过接雨水的话，建议先做一做接雨水，可以参考我的题解：[42. 接雨水](https://programmercarl.com/0042.接雨水.html)
...
如上代码并不能通过 leetcode，超时了，因为时间复杂度是 O(n^2)。
...
所以需要循环查找，也就是下面在寻找的过程中使用了 while，详细请看下面注释，整理思路在题解：[42. 接雨水](https://programmercarl.com/0042.接雨水.html)中已经介绍了。
